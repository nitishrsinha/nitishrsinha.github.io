...
echo "       -> paste the printed id into wrangler.toml"
echo ""
echo "  2. echo -n '${TOTP_SECRET}' | wrangler secret put TOTP_SECRET"
echo ""
echo "  3. cd ../private && STATICRYPT_PASSWORD=auto ./encrypt.sh"
echo "       -> re-encrypts everything with a fresh random password and"
echo "          prints the derived key + the 'wrangler secret put STATICRYPT_KEY' command"
echo ""
